...
function RecordingCard({ recording }: { recording: CallRecording }) {
    ...
    return (
        ...
        {/* CARD CONTENT */}
            <CardContent>
                <div
                    className="w-full aspect-video bg-muted/50 rounded-lg flex items-center justify-center
                ...
                >
                    ...
                    group-hover:bg-primary transition-colors duration-300">
                        <PlayIcon className="size-6 text-muted-foreground group-hover:text-primary-foreground
